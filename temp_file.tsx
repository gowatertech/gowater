      ...
      {isMobile ? (
        ...
        <Tabs defaultValue="entregas" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="mapa">
            <div className="mb-3">
              <label className="text-sm font-medium mb-1 block">Seleccionar Ruta:</label>
            ...
            <ResponsiveMapContainer minHeight="70vh">
              ...
              >
                ...
                <RouteLines deliveries={deliveriesByRoute} currentPosition={currentPosition} />
                
                {/* Marcador del almacén (punto 0) */}
                <Marker 
                  position={[19.075380, -70.128822]} 
                  icon={L.divIcon({
                    className: 'custom-div-icon',
                    html: `<div class="marker-pin bg-red-500 flex items-center justify-center text-white rounded-full w-8 h-8 border-2 border-white shadow-md">0</div>`,
                    iconSize: [30, 30],
                    iconAnchor: [15, 15]
                  })}
                >
                  <Popup>
                    <div className="p-2 w-[250px]">
                      <h3 className="font-medium text-lg">Almacén (punto 0)</h3>
                      <p className="text-sm">Punto de inicio de todas las rutas</p>
                    </div>
                  </Popup>
                </Marker>
                
                {deliveriesByRoute.map((delivery) => (
                  <Marker 
                    key={delivery.id}
