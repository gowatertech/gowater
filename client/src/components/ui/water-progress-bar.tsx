...
const WaterProgressBar = memo(function WaterProgressBar({
  progress,
  total,
  completed,
  className,
        ...
        <div className="flex justify-between mb-1">
          ...
          {showPercentage && (
            <span className="text-sm font-medium text-muted-foreground">
              {completed} / {total} ({roundedProgress}%)
            </span>
          )}
        </div>
      )}
      <div className={cn(
        ...
        <div 
          className={cn(
            ...
            "bg-gradient-to-r from-blue-300 to-blue-500 relative"
          )}
