...
export function DesignCredit() {
  return (
    <div className="fixed bottom-1 right-1 z-40 px-3 py-1 bg-background/80 backdrop-blur-sm text-center border rounded-sm text-xs text-muted-foreground font-medium flex items-center gap-1 shadow-sm">
