...
export function DesignCredit() {
  return (
    <div className="fixed bottom-36 right-2 z-40 px-2 py-1 bg-background/80 backdrop-blur-sm text-center border rounded-md text-xs text-muted-foreground font-medium flex items-center gap-1 shadow-sm">
