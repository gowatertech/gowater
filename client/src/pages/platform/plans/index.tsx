        ...
        <div className="bg-gradient-to-r from-blue-600 via-blue-600 to-indigo-700 rounded-2xl p-4 sm:p-6 text-white">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-blue-100 mt-1 text-sm">Administra los planes de suscripción disponibles</p>
            </div>
            <Button size="sm" onClick={() => setLocation("/platform/plans/new")} className="bg-white text-blue-700 hover:bg-blue-50 border-0">
