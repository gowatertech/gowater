...
export const createRecurringOrdersEndpoints = (router: Router) => {
  ...
  router.get("/customers/:customerId/recurring-orders", async (req, res) => {
    try {
  ...
  router.get("/recurring-orders/:id", async (req, res) => {
    try {
  ...
  router.patch("/recurring-orders/:id", async (req, res) => {
    try {
      const id = parseInt(req.params.id);
      if (isNaN(id)) {
        return res.status(400).json({ error: "ID inválido" });
  ...
  router.patch("/recurring-orders/:id/status", async (req, res) => {
    try {
      const id = parseInt(req.params.id);
      if (isNaN(id)) {
        return res.status(400).json({ error: "ID inválido" });
  ...
  router.delete("/recurring-orders/:id", async (req, res) => {
    try {
      const id = parseInt(req.params.id);
      if (isNaN(id)) {
        return res.status(400).json({ error: "ID inválido" });
  ...
  router.get("/recurring-orders/:id/items", async (req, res) => {
    try {
      // Verificar si es el ID especial 'new'
      if (req.params.id === 'new') {
  ...
  router.post("/recurring-orders/:id/items", async (req, res) => {
    try {
  ...
  router.patch("/recurring-order-items/:id", async (req, res) => {
    try {
      const id = parseInt(req.params.id);
      if (isNaN(id)) {
        return res.status(400).json({ error: "ID inválido" });
  ...
  router.delete("/recurring-order-items/:id", async (req, res) => {
    try {
      const id = parseInt(req.params.id);
      if (isNaN(id)) {
        return res.status(400).json({ error: "ID inválido" });
  ...
  // =====================================================================
  router.post("/recurring-orders/:id/generate", async (req, res) => {
    try {
