...
export function registerPlatformEndpoints(routerOrApp: Router | Express) {
  // Endpoint de prueba
  routerOrApp.get('/platform-test', async (req, res) => {
    try {
  ...
  routerOrApp.get('/platform-tables', async (req, res) => {
    try {
  ...
  registerPlatformRoutes(routerOrApp);
